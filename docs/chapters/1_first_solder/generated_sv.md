...
![Sätt temperaturen på 350 grad Celsius](set_temperature_to_350_degrees_celsius.jpg)

Sätt rökutsugsrör på två.

![sätt rökutsug på två](set_fume_extractor_control_to_two.jpg)

Sätt rökutsugsrör över bordet.

![Sätt rökutsugsrör över bordet](set_fume_extractor_above_workpiece.jpg)
...
![Lödningsjärnet har en silverspets](soldering_iron_has_iron_tip.jpg)

Spetsen ser svart ut om lödningsjärnet är lämnat kvar i dåligt skick:

![Lödningsjärnet har ingen silverspets](soldering_iron_needs_tinning.jpg)
...
![Sätt två resistorer mot varann i en hjälpande hand](two_resistors_in_helping_hand.jpg)

Det måste inte finnas tomrum mallan den två resistorer.

![Sätt två resistorer mot varann i en hjälpande hand](two_resistors_in_helping_hand_zoom.jpg)

Sätt tänn också till lödningsplatsen.
Lödningsplatsen är var tråder av resistorer nuddar varan.

![Sätt tänn till lödningsplatsen](before_soldering.jpg)
...
![Lödningen bör ser ut smidigt](soldering_worked.jpg)
