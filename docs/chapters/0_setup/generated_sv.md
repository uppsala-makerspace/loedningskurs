# Förberedning av att löda


Hitta en lödningsjärn.

![En lödningsjärn](soldering_iron.jpg)
...
![Lödningstimern är släckt](soldering_timer.jpg)
...
![Tryck på den runda knappen åt sidan av lödningstimern](solder_timer_on.jpg)

Sätt kontrollen av lödningsjärnet på, med en temperatur van 350 grad Celsius.

![Kontrollen av en lödningsjärn](soldering_iron_control.jpg)

Hitta en så kallade 'hjälpande hand'.

![En hjälpande hand](helping_hand.jpg)
...
![Sätt på ångutsugningen med att vrida knappen till två](fume_extractor_control.jpg)
